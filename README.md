...
1. Отдельные **папки**, названные в соответствии с адресами сайтов, вошедших в коллекцию. Внутри папок:
	...
	- **site-archive.cdx** – cdx файл
	- **site-archive.db** – база данных, составленная автоматически на основе метаданных
	- **site-archive.log** – лог
	- **site-archive.warc.gz** – архив warc
