...
В коллекцию вошли сайты интересные мне, в рамках данного курса, сайты, а именно:
 ...
 1. [«Справочник ТВ оборудования Golden Age TV© LLP»](https://olden-agetv.co.uk/equipment.php?TypeID=2)
...
3. **metawarc-analysys** - папка с "сырыми" результатами анализа, с помощью metawarc
